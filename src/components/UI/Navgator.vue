<template>
    <transition enter-active-class="transition-transform duration-100 ease-out"
        ...
        <ul v-show="showBottomNav"
            class="flex dark:bg-x-dark-bg bg-x-light-bg z-[999] items-center gap-2 w-full h-16 text-text-primary fixed bottom-0 overflow-hidden"
            ...
            <li class="flex-1 h-full active:bg-x-light-surfaceActive dark:active:bg-x-dark-surfaceActive">
                <button @click="router.replace('/home')" :class="{ 'text-primary': route.name == 'Home' }"
                    class="flex flex-col items-center justify-center gap-0.5 w-full h-full" to="/feed">
                    <svg v-if="route.name === 'Home'" xmlns="http://www.w3.org/2000/svg" width="24"
                    ...
                    <span class="text-[10px] leading-none font-medium">Início</span>
                </button>
            </li>

            <li class="flex-1 h-full active:bg-x-light-surfaceActive dark:active:bg-x-dark-surfaceActive">
                <router-link class="flex flex-col outline-none text-inherit items-center justify-center gap-0.5 h-full relative"
                    ...
                    <svg v-else aria-label="Mensagens" role="img" viewBox="0 0 24 24" class="w-[22px] h-[22px]"
                        style="">
                        <title>Mensagens</title>
                    ...
                    <span class="text-[10px] leading-none font-medium">Mensagens</span>
                    <span v-show="unreadMessagesCount > 0"
                        class="min-w-4 h-4 dark:shadow-[rgb(32,32,32),0px_0px_0px_2px] text-[10px] p-0.5 flex items-center justify-center rounded-3xl font-semibold absolute top-[6px] right-[12px] bg-x-light-blue text-[#fff]">
            ...
            <li class="flex-1 h-full active:bg-x-light-surfaceActive dark:active:bg-x-dark-surfaceActive">
                <router-link class="flex flex-col outline-none text-inherit items-center justify-center gap-0.5 h-full"
                    :class="{ 'text-primary': route.name == 'Reels' }" to="/reels">
                    <svg v-if="route.name === 'Reels'" aria-label="Reels" role="img" viewBox="0 0 24 24"
                    ...
                    <svg v-else aria-label="Videos" role="img" viewBox="0 0 24 24" class="w-[22px] h-[22px]"
                    ...
                    <span class="text-[10px] leading-none font-medium">Vídeos</span>
                </router-link>
            </li>

            <li class="flex-1 h-full active:bg-x-light-surfaceActive dark:active:bg-x-dark-surfaceActive">
                <button @click="goToNotification" class="flex flex-col items-center justify-center gap-0.5 w-full h-full relative"
                    ...
                    <span class="text-[10px] leading-none font-medium">Notificações</span>
            ...
            <li class="flex-1 h-full active:bg-x-light-surfaceActive dark:active:bg-x-dark-surfaceActive">
                <button class="flex flex-col items-center justify-center gap-0.5 text-inherit w-full h-full"
                    ...
                    <svg v-else aria-label="Perfil" role="img" viewBox="0 0 24 24" class="w-[22px] h-[22px]"
                    ...
                    <span class="text-[10px] leading-none font-medium">Perfil</span>
                </button>
            </li>
        </ul>
    </transition>
